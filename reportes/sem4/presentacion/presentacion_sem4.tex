...
\begin{frame}{Software final de adquisición}
  \centering
  \imgph[0.92]{exports/captura_20260624_200325.png}\\[2pt]
...
\begin{frame}{Conclusiones}
  \begin{enumerate}
    \item \textbf{DAQ validado (avance central):} 12 bits, 54 MS/s, sin pérdida de
  ...
  \end{enumerate}
  \begin{block}{El hito del periodo}
    El objetivo era la prueba fotoacústica completa (sensor excitado y sensando). No
    se concretó, pero \alert{diseñar y programar la FPGA como DAQ a estas frecuencias
    de trabajo y con materiales de bajo costo es un \textbf{hito}}: la plataforma de
    adquisición queda resuelta y la detección se reduce a un problema acotado de
    front-end analógico.
  \end{block}
\end{frame}
