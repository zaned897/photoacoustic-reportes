...
- 2026-06-24 — Windows/Claude: **revisión mayor** del reporte (reescrito, **15 pág** desde 22). Añadidos: sección **Materiales** (+ link al repo de código FPGA), subsección **"El costo del ciclo de lectura completo"** (8→12 bit y 27→54 MS/s → BRAM/UART/sincronía) y reflejado en el abstract; **encuadre OBJETIVO** de la detección (sin "anticipada/más difícil"; 4 razones con datos); narrativa EM **"se veía como acústica en el osc. pero se perdía al pasar al ADC"** + impedancia como **obstáculo** (caption de fig reescrito); **figura de software final** (GUI `captura_*`); figuras más pequeñas + flotantes para acortar. Presentación alineada (**24 lám**): + Materiales, + Software, detección objetiva, punto ADC-loss. PDFs semifinales regenerados en `entregables/`.
