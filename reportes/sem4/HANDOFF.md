...
- 2026-06-24 — Mac/Claude: renombrado el screenshot del GUI del DAQ `figuras/exports/captura_20260624_200325.png` → **`figuras/daq-python-software.png`** (`git mv`). Es el screenshot del software de adquisición (distinto de la figura generada `daq-captura.png`); aún NO está referenciado en el `.tex`. `exports/` queda solo con `ventana_20260624_200320.csv` (datos crudos).
